...
export default function RegisterPage() {
  ...
  const redirectAfterAuth = useCallback(() => {
    ...
    router.push(`/${country}/${redirectPath}`);
  }, [country, getSafeReturnTo, role, router]);
  ...
  return (
    <>
      <Navbar />
      <main className="min-h-[calc(100vh-4rem)] bg-[#F9FAFB] dark:bg-neutral-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <h2 className="mt-0 text-center text-3xl font-bold tracking-tight text-[#171717] dark:text-white">
            {t('register.title')}
          </h2>
            ...
            <div>
              ...
              <div className="mt-2 relative">
                ...
                <input
                  ...
                  className={`block w-full rounded-full border-0 py-3.5 pl-11 pr-12 text-[#171717] dark:text-white bg-[#F9FAFB] dark:bg-neutral-950 ring-1 ring-inset focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 transition-all ${
                    errors.password 
                      ? 'ring-red-300 dark:ring-red-900 focus:ring-red-500' 
                      : 'ring-neutral-200 dark:ring-neutral-800 focus:ring-[#171717] dark:focus:ring-white'
                  }`}
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 flex w-12 items-center justify-center rounded-r-full text-neutral-400 transition-colors hover:text-[#171717] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#171717] dark:hover:text-white"
